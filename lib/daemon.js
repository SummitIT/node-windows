...
Object.defineProperties(this,{
 ...
 directory: {
   ...
   value: function(dir){
     ...
     let abc = path.resolve(path.join(this._directory,daemonDir));
     if(config.daemonDir!=null) {
       let _tempDir =  config.daemonDir;
       console.log('abc|_tempDir',_tempDir);
       abc = path.resolve(path.join(_tempDir,daemonDir));
     }
     if (dir){
       abc = path.resolve(path.join(path.resolve(dir),daemonDir));
     }
     console.log('abc',abc);
     return abc;
   }
